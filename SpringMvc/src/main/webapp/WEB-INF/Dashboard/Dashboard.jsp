					...
					if(data==""){
						...
						$('#noSortData').hide();
							...
							$.each(data, function(i, user) {
				         		var tblRow = "<tr>" + "<td>" + user.materialName + "</td>" + "<td>" + user.storageLocName + "</td>"+"<td>" + user.batchNo + "</td>"  
				         		+"<td>"+user.qtyAval+"</td></tr>";
				 ...
				 var barsVisualization;
				  ...
				  function displayMaterials(Array)
				  {
				   ...
				   data.addColumn('string','Material');
				    ...
				    barsVisualization = new google.visualization.ColumnChart(document.getElementById('chart1'));
				    barsVisualization.draw(data,{vAxis:{'title': 'Quantity'},hAxis:{'title': 'Material'}});
	...
	$(function() {
		...
		$( ".portlet" )
			...
			.find( ".portlet-header" )
				...
				.prepend( "<span class='ui-icon ui-icon-minusthick portlet-toggle'></span><span class='ui-icon ui-icon-close close'></span>");
...
<!--------------------------------------------- Total Stock begin --------------------------------------------------------------------->	
	<div class="portlet">
		<div  class="portlet-header"><spring:message code="label.top5Materials"/> </div>
		    ...
		    <div align="left" id="chart1" class="portlet-content" style="width:410px; height:250px;">
		    <div>
		    ...
		    <div align="right" id="top5Materials">
		     <a href="" onclick="return popitup('allmaterialsDisplayHome.mnt')"> <h4><u>View More</u></h4> </a>   
		   </div>
	</div>
	
	<div class="portlet">
		<div class="portlet-header"> <spring:message code="label.totalStock"/> </div>
	...
	<tr><td><spring:message code="label.storageLocation"/> </td> 
	<td><form:select path="storageLocationId" id="storage" onchange="getTotalStock(this.id)">
...
<div class="portlet">
		<div class="portlet-header"><spring:message code="label.invoiceToPay"/> </div>
		<div class="portlet-content" align="right" style="height: 150px; overflow-y:scroll; overflow-x: scroll;">
		<table class="table">
		<tr>
		<c:choose>
	...
	<spring:message code="label.noData"/>
		...
		<c:if test="${not empty deliveryInTheYears }">
			<a href="" onclick="return popitup('allGoodsDelivery.mnt')"> <h4><u>View More</u></h4> </a>
		</c:if>
		</div>
...
<div class="portlet">
		<div class="portlet-header" align="top"> <spring:message code="label.invoiceToCollect"/> </div>
		<div class="portlet-content" style="height: 150px; overflow-y:scroll; overflow-x: scroll;">
			<table class="table">
		<tr>
		<c:choose>
	...
	<spring:message code="label.noData"/>
		...
		<div align="right">
			...
			<a href="" onclick="return popitup('allinvoiceToCollects.mnt')"> <h4><u>View More</u></h4> </a>
...
<!--------------------------------------------- Pending PurchaseOrder begin --------------------------------------------------------------------->	
	<div class="portlet">
		<div class="portlet-header"><spring:message code="label.pendingPurchaseOrder"/> </div>
		<div class="portlet-content"  style="height: 150px; overflow-y:scroll; overflow-x: scroll;">
	...
	<a href="" onclick="return popitup('allPendingPoOrder.mnt')"> <h4><u>View More</u></h4> </a></div>
</c:if>
</div>
	</div>
	...
	<div class="portlet">
		<div class="portlet-header"> <spring:message code="label.tobeReorderedMaterial"/> </div>
		<div class="portlet-content"  style="height: 150px; overflow-y:scroll; overflow-x: scroll;">
...
<spring:message code="label.noData"/>
		...
		<div align="right">
		<a href="" onclick="return popitup('allToBeReorderMatHome.mnt')"> <h4><u>View More</u></h4> </a></div></c:if>
		</div>
		</div>
