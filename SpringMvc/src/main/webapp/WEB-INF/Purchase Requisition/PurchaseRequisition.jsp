...
<<<<<<< .mine
																	...
																	requestedDate : {
																		...
																		dpDate:"<font style='color: red;'><b>Requested Date allows only date format</b></font>"
																	},
=======
...
=======
						alert("Please Enter AtLeast One Purchase Requisition Line");
>>>>>>> .r6799
						document.getElementById("addmessage").style.display = "block";
<<<<<<< .mine
						$('#addmessage').html("Please Enter AtLeast One Puchase Requistion Line");
=======
...
=======
																	purchaseReqNoEdit : "<font style='color: red;'><b>Purchase ReqNo is Required</b></font>",
>>>>>>> .r6799
							...
							<div align="center">
									...
									<div id="users-contain-quotLine">
										...
										<table id="quotLineAdd" class="table">
											<thead>
												<tr>
													<th><spring:message code="label.prmaterial" /><font color="red">*</font></th>
													<th><spring:message code="label.prqty"/><font color="red">*</font></th>
													<th><spring:message code="label.quom" /><font color="red">*</font></th>
													<th><spring:message code="label.requireddate" /></th>
													<th><spring:message code="label.qstatus" /><font color="red">*</font></th>
													<th><spring:message code="label.qplant" /><font color="red">*</font></th>
													<th><spring:message code="label.storloc" /><font color="red">*</font></th>
												</tr>
											</thead>
											<tbody>
