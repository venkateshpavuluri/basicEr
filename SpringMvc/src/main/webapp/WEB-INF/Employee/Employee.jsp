							...
							<div align="center">
									...
									<script>
										...
										$(function() {
											...
											allFields = $([]).add(managers).add(mvalue).add(projects).add(pvalue).add(startDate).add(endDate).add(hiddenempID),
											 tips = $(".validateTips");
																			...
																			if (hiddenempID
																				...
																				$("#empAdd tbody")
																						.append(
																								...
																								+ " class='textbox'readonly/></td>" 
																								     + "<td align='center'><input type='text' name='startDate' id='startDate"
																								      + btempid
																								     + "' value="
																								     + startDate
																										.val()
																								     + "  class='textbox'readonly/></td>"
																										+ "<td align='center'><input type='text' name='endDate' id='endDate"
																										+ btempid
																										+ "' value="
																										+ endDate
																												.val()
										...
										<table id="empAdd" class="table">
											<thead>
												<tr>
													...
													<th><spring:message code="label.Manager" /><font color="red">*</font></th>
													<th><spring:message code="label.project" /><font color="red">*</font></th>
													<th><spring:message code="label.startDate" /><font color="red">*</font></th>
													<th><spring:message code="label.endDate" /><font color="red">*</font></th>
												</tr>
											</thead>
											<tbody>
											...
											<table id="AddEmpEdit" class="table">
												...
												<tbody>
													<c:forEach var="emplinelist"
																		...
																		<td><spring:bind
																		 ...
																		 <spring:bind
																			...
																			<input type="hidden" name="projectsEdit"
																				class="textbox" 
																				value="${emplinelist.project_IdEdit}" id="projectsEdit${emplinelist.employeeManager_IdEdit}" />
																		</spring:bind>
																		<td><spring:bind
																			path="EmployeeCommand.projectName">
																			<input type="text" name="projectName"
																				class="textbox" readonly="readonly"
																				value="${emplinelist.projectName}" id="projectName${emplinelist.employeeManager_IdEdit}" />
																		</spring:bind></td> 
																		<td><spring:bind
															...
															onclick="javascript:editEmpDetailsInEdit(${emplinelist.employeeManager_IdEdit})"><img
