	...
	<div class="divUserDefault">
		...
		<div id="tabs" class="TabbedPanels">
			<ul class="TabbedPanelsTabGroup">
				<c:forEach var="EvaluationCriteriavalues" items="${EvaluationCriteriavalues}">
				...
				<div align="left">
					<form:form action="EvaluationCriteriaSearch.mnt" method="get"
						...
						<table class="tableGeneral">
							...
							<tr>
								<td colspan="2"><c:forEach var="EvaluationCriteriaAdd"
										...
										<div class="alert-success" id="savemessage">
											...
											<spring:message code="label.EvaluationCriteria"/> <spring:message code="label.saveSuccess"></spring:message>
										</div>
									</c:forEach>
							<c:if test="${param.listwar!=null }">							
								...
								<spring:message code="label.EvaluationCriteria"/>	<spring:message code="label.saveFail"/>
										</div>	</c:if>
								<c:forEach var="EvaluationCriteriaUpdate"
										items="${EvaluationCriteriaUpdate}">
										<div class="alert-success" id="successmessage">
											<strong><spring:message code="label.success"/></strong>
											<spring:message code="label.EvaluationCriteria"/> <spring:message code="label.updateSuccess"></spring:message>
										</div>
									</c:forEach>
							<c:forEach var="EvaluationCriteriaUpdateError"
										items="${EvaluationCriteriaUpdateError}">
										<div class="alert-danger" id="successmessage">
											<strong><spring:message code="label.error"/></strong>
											<spring:message code="label.EvaluationCriteria"/> <spring:message code="label.updateFail"></spring:message>
										</div>
									</c:forEach><c:forEach var="EvaluationCriteriadelete"
										items="${EvaluationCriteriadelete}">
										<div class="alert-success" id="successmessage">
										<strong><spring:message code="label.success"/></strong>
											<spring:message code="label.EvaluationCriteria"/> <spring:message code="label.deleteSuccess"></spring:message>
										</div>
									</c:forEach><c:forEach var="EvaluationCriteriadeleteError"
										items="${EvaluationCriteriadeleteError}">
										<div class="alert-danger" id="successmessage">
										<strong><spring:message code="label.error"/></strong>
											<spring:message code="label.EvaluationCriteria"/> <spring:message code="label.deleteFail"></spring:message>
										</div>
									</c:forEach></td>
							</tr>
					...
					<c:if test="${agtvalues!=null }">
						<display:table id="EvaluationCriteria" name="EvaluationCriteria"
							requestURI="EvaluationCriteriaSearch.mnt" pagesize="5" class="table">


							<%-- <display:column property="EvaluationCriteria_Id" title="EvaluationCriteria_Id" media="html" sortable="true" ></display:column> --%>
							<display:column property="evaluationCriteria" titleKey="label.EvaluationCriteria"
								media="html" sortable="true" />
							<display:column property="weightingFactor" titleKey="label.WeightingFactor"
								media="html" sortable="true" />
				...
				<div align="left" class="TabbedPanelsContent">
					...
					<form:form action="EvaluationCriteriaadd.mnt" method="POST"
						...
						<table class="tableGeneral">
							...
							<tr>
								<td colspan="2"><c:forEach var="addEvaluationCriteriaDuplicate"
										items="${addEvaluationCriteriaDuplicate}">
										<div class="alert-warning" id="savemessage">
											<strong><spring:message code="label.warning"/></strong>
											<spring:message code="label.EvaluationCriteria"/> <spring:message code="label.duplicateCheck"></spring:message>
										</div>
									</c:forEach></td>
							</tr>
							<tr>
								<td><spring:message code="label.EvaluationCriteria" /><font
									color="red">*</font></td><td><form:input path="evaluationCriteria"
										id="evaluationCriteria" class="textbox" maxlength="50"/></td>

							</tr>
							<tr>
								<td><spring:message code="label.WeightingFactor" /><font
									color="red">*</font> </td><td><form:input path="weightingFactor"
										id="weightingFactor" class="textbox" maxlength="50"/></td>
							...
							<div align="center">
																				...
																				$("#PrevMainAdd tbody")
																						.append(
																								"<tr id="+btPrevMainid+">"
																											...
																											+ "<td align='center'><input type='text' name='evaluationSubCriteria' id='evaluationSubCriteria"
																										      + btPrevMainid
																										     + "' value="
																										 	...
																										 	+ "<td align='center'><input type='text' name='score' id='score"
																										      + btPrevMainid
																										     + "' value="
																										     + score
																												.val()
									...
									<div id="dialog-form-PrevMain" title="Add New Resource Request Details">
										<p class="validateTips">All form fields are required.</p>
										<table class="tableGeneral">
									
<tr>
								<td><spring:message code="label.EvaluationSubCriteria" /><font
									color="red">*</font></td><td><form:input path="evaluationSubCriteria"
										id="evaluationSubCriteria" class="textbox" maxlength="50"/></td>

							</tr>
							<tr>
								<td><spring:message code="label.Score" /><font
									color="red">*</font> </td><td><form:input path="score"
										id="score" class="textbox" maxlength="50"/></td>

											<td>					
											<input type="hidden"
													name="hiddenEvaluationCriteriaPopUp" id="hiddenEvaluationCriteriaPopUp" value="0" /></td>
											</tr>
 										</table>
									</div>
										...
										<table id="PrevMainAdd" class="table">
											<thead>
												<tr>
													...
													<th><spring:message code="label.EvaluationSubCriteria" /><font color="red">*</font></th>
													<th><spring:message code="label.Score" /><font color="red">*</font></th>
									...
									<button id="AddPrevMain" type="button">Add New Resource Request Details</button>
					...
					<c:forEach var="EvaluationCriteriavalues" items="${EvaluationCriteriavalues }">
						...
						<form:form action="EvaluationCriteriaUpdate.mnt" method="POST"
							...
							<table class="tableGeneral">
								...
								<tr>
									<td colspan="2"><c:forEach var="editEvaluationCriteriaDuplicate"
								...
								<div id="tab1">
									<div align="center">
										...
										<div id="dialog-form-PrevMainEdit" title="Add New Production Plan Line Details">
											<p class="validateTips">All form fields are required.</p>
											<table class="tableGeneral">
									...
									<td><form:input path="evaluationSubCriteriaEdit"
											id="evaluationSubCriteriaEdit" class="textbox" maxlength="50"/></td>
								</tr>
								
								<tr>
									<td><spring:message code="label.Score" /><font
										color="red">*</font></td>
									<td><form:input path="scoreEdit"
											id="scoreEdit" class="textbox" maxlength="50"/></td>	<td>					
											<input type="hidden"
											...
											<table id="AddPrevMainEdit" class="table">
												...
												<tbody>
													<c:forEach var="evaluationSubCriteriaList"
															...
															<c:set var="edit1" value="${evaluationSubCriteriaList.evaluationSubCriteriaIdEdit}"></c:set> 
														
																<tr id="${evaluationSubCriteriaList.evaluationSubCriteriaIdEdit}">
																
                                                                    <spring:bind
																			path="EvaluationCriteriaadd.evaluationSubCriteriaId">
																			<input type="hidden" name="eveCriteriaEditt"
																				class="textbox" 
																				value="${evaluationSubCriteriaList.evaluationSubCriteriaIdEdit}" id="evaluationSubCriteriaId${evaluationSubCriteriaList.evaluationSubCriteriaIdEdit}" />
																		</spring:bind>
																		...
																		<td><spring:bind
																			...
																			<input type="text" name="evaluationSubCriteriaEdit"
																				...
																				value="${evaluationSubCriteriaList.evaluationSubCriteriaEdit}"  id="evaluationSubCriteriaEdit${evaluationSubCriteriaList.evaluationSubCriteriaIdEdit}"/>
																		</spring:bind></td>
																		
																		<td><spring:bind
																			path="EvaluationCriteriaadd.scoreEdit">
																			<input type="text" name="scoreEdit"
																				class="textbox" readonly="readonly"
																				value="${evaluationSubCriteriaList.scoreEdit}"  id="scoreEdit${evaluationSubCriteriaList.evaluationSubCriteriaIdEdit}"/>
																		</spring:bind>
								
																	<input type="hidden" name="${evaluationSubCriteriaList.evaluationSubCriteriaIdEdit}Check" id="${evaluationSubCriteriaList.evaluationSubCriteriaIdEdit}Check" value="0"/></td>
																		<td><a href="#"
															
															onclick="javascript:editPrevMaintenanceDetailsInEdit(${evaluationSubCriteriaList.evaluationSubCriteriaIdEdit})"><img src="images/Edit.jpg" height="25px" width="25px"
								...
								<table>
									...
									<td colspan="2"><c:choose>
										...
										value="<spring:message
								code="label.update" />"
										class="btn btn-primary" id="updateSubmit" /></c:when>
										<c:otherwise>
