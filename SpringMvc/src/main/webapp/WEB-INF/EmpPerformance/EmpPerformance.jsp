																								...
																								"<tr id="+btPrevMainid+">"
																								     ...
																								     + "<td ><spring:bind path='EmpPerformance.kPIId'><input type='hidden' name='kPIId' id='kPIId"
																										...
																										+ " class='textbox'readonly/></td>" 
																										 	...
																										 	+ "<td align='center'><input type='text' name='rating' id='rating"
																										      + btPrevMainid
																										     + "' value="
																										     + rating
																												.val()
																										     + "  class='textbox'readonly/></td>"
																										 	+ "<td align='center'><input type='text' name='comment' id='comment"
																										      + btPrevMainid
																										     + "' value="
																										     + comment
																												.val()
										...
										<table id="PrevMainAdd" class="table">
											<thead>
												<tr>
													...
													<th><spring:message code="label.kpi" /><font color="red">*</font></th>
													<th><spring:message code="label.rating" /><font color="red">*</font></th>
													<th><spring:message code="label.comment" /><font color="red">*</font></th>
													<th><spring:message code="label.evaluationBy" /><font color="red">*</font></th>
											...
											<table id="AddPrevMainEdit" class="table">
												...
												<tbody>
													<c:forEach var="preMainCatList"
															...
															<c:set var="edit1" value="${preMainCatList.performanceReviewKPIIdEdit}"></c:set> 
														
																<tr id="${preMainCatList.performanceReviewKPIIdEdit}">
																
                                                                    <spring:bind
																			path="EmpPerformance.performanceReviewKPIId">
																			<input type="hidden" name="empPerEditt"
																				class="textbox" 
																				value="${preMainCatList.performanceReviewKPIIdEdit}" id="performanceReviewKPIId${preMainCatList.performanceReviewKPIIdEdit}" />
																		</spring:bind>
																           ...
																           <spring:bind
																			...
																			<input type="hidden" name="kPIIdEdit"
																				class="textbox" 
																				value="${preMainCatList.kPIIdEdit}" id="kPIIdEdit${preMainCatList.performanceReviewKPIIdEdit}" />
																		</spring:bind>
																		<td><spring:bind
																			path="EmpPerformance.kpiName">
																			<input type="text" name="kpiName"
																				class="textbox" readonly="readonly"
																				value="${preMainCatList.kpiName}" id="kpiName${preMainCatList.performanceReviewKPIIdEdit}" />
																		</spring:bind></td>
																		...
																		<td><spring:bind
																			...
																			<input type="text" name="ratingEdit"
																				class="textbox" readonly="readonly"
																				value="${preMainCatList.ratingEdit}"  id="ratingEdit${preMainCatList.performanceReviewKPIIdEdit}"/>
																		</spring:bind></td>
																		<td>
																	<spring:bind
																			...
																			<input type="text" name="commentEdit"
																				class="textbox" readonly="readonly"
																				value="${preMainCatList.commentEdit}"  id="commentEdit${preMainCatList.performanceReviewKPIIdEdit}"/>
																		</spring:bind></td>
																		 <spring:bind
																			path="EmpPerformance.evaluationByEdit">
																			<input type="hidden" name="evaluationByEdit"
																				class="textbox" 
																				value="${preMainCatList.evaluationByEdit}" id="evaluationByEdit${preMainCatList.performanceReviewKPIIdEdit}" />
																		</spring:bind>
																		<td><spring:bind
																			path="EmpPerformance.empName">
																			<input type="text" name="empName"
																				class="textbox" readonly="readonly"
																				value="${preMainCatList.empName}" id="empName${preMainCatList.performanceReviewKPIIdEdit}" />
																		</spring:bind>
																	<input type="hidden" name="${preMainCatList.performanceReviewKPIIdEdit}Check" id="${preMainCatList.performanceReviewKPIIdEdit}Check" value="0"/></td>
																		<td><a href="#"
															
															onclick="javascript:editEmpPerformanceDetailsInEdit(${preMainCatList.performanceReviewKPIIdEdit})"><img src="images/Edit.jpg" height="25px" width="25px"
																id="${preMainCatList.performanceReviewKPIIdEdit}"></img></a></td>
														<td><a href="#"
															id="${preMainCatList.performanceReviewKPIIdEdit}"
