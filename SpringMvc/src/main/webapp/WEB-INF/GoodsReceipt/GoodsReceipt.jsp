...
<<<<<<< .mine
			...
			$.ajax({
				...
				success : function(data) {
					...
					alert(oldvalue+ "on "+newvalue);
				}
					//var s=parseFloat($("#qtyHidden").val())+parseFloat(oldvalue);
					alert("tothidden:"+oldvalue);
				
					
						alert("hai");
						$("#availableQty").val(data);
						alert("d:"+$("#availableQty").val());
		...
		if(matHiddenId==0){
			...
			$.ajax({
				...
				success : function(data) {
					...
					alert("s is:"+$("#availableQtyEdit").val());
				},
				error : function(e) {
					alert('Error: ' + e);
				}
...
<script>
	$(function() {
		...
		$("#DCDate").datepicker();
		$("#DocketDate").datepicker();
		$("#receivingDateEdit").datepicker();
		$("#DCDateEdit").datepicker();
		$("#DocketDateEdit").datepicker();
		$("#inspectedDTTM").datepicker();
		$("#inspectedDTTMEdit").datepicker();
...
<<<<<<< .mine
                                                ...
                                                var value = $.jStorage.get($('#materialids' + id).val()-$('#receivedQty' + id)
														.val());
                       						 alert("available Quantity"+value);
=======
                                                alert("materialId:"+$('#materialids'+id).val());
...
>>>>>>> .r6129
                   ...
                   <form:hidden path="aid"/>
							...
							<c:choose>
									<c:when test="${save}"><input type="submit" value="Save" name="Save"
