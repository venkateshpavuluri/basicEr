...
public class Material {
	...
	/**
	 * @param materialDescriptionEdit the materialDescriptionEdit to set
	 */
	...
	/**
	 * @param alternateUOMEdit the alternateUOMEdit to set
	 */
	...
	/**
	 * @param maxDeliveryTimeUOMEdit the maxDeliveryTimeUOMEdit to set
	 */
	...
	/**
	 * @param maxDeliveryTimeEdit the maxDeliveryTimeEdit to set
	 */
	...
	/**
	 * @param purchaseUOMEdit the purchaseUOMEdit to set
	 */
	...
	/**
	 * @param avgWeightEdit the avgWeightEdit to set
	 */
	...
	/**
	 * @param avgHeightEdit the avgHeightEdit to set
	 */
	...
	/**
	 * @param avgLengthEdit the avgLengthEdit to set
	 */
	...
	/**
	 * @param avgVolumeEdit the avgVolumeEdit to set
	 */
	...
	/**
	 * @param weightUOMEdit the weightUOMEdit to set
	 */
	...
	/**
	 * @param heightUOMEdit the heightUOMEdit to set
	 */
	...
	/**
	 * @param lengthUOMEdit the lengthUOMEdit to set
	 */
	...
	/**
	 * @param dimensionEdit the dimensionEdit to set
	 */
	...
	/**
	 * @param shelfLifeEdit the shelfLifeEdit to set
	 */
	...
	/**
	 * @param shelfLifeUOMEdit the shelfLifeUOMEdit to set
	 */
	...
	/**
	 * @param materialTypeValues the materialTypeValues to set
	 */
	...
	/**
	 * @param materialCategoryName the materialCategoryName to set
	 */
	...
	/**
	 * @param taxCategoryName the taxCategoryName to set
	 */
	...
	/**
	 * @param materialCodeEdit the materialCodeEdit to set
	 */
	...
	/**
	 * @param materialTypeEdit the materialTypeEdit to set
	 */
	...
	/**
	 * @param taxCatogeryEdit the taxCatogeryEdit to set
	 */
	...
	/**
	 * @param uomEdit the uomEdit to set
	 */
	...
	/**
	 * @param maxDeliveryTimeUOM the maxDeliveryTimeUOM to set
	 */
	...
	/**
	 * @param alternateUOM the alternateUOM to set
	 */
	...
	/**
	 * @param taxCatogery the taxCatogery to set
	 */
	...
	/**
	 * @param activeEdit the activeEdit to set
	 */
	...
	/**
	 * @param salesUOM the salesUOM to set
	 */
	...
	/**
	 * @param purchaseUOM the purchaseUOM to set
	 */
	...
	/**
	 * @param avgWeight the avgWeight to set
	 */
	...
	/**
	 * @param lengthUOM the lengthUOM to set
	 */
	...
	/**
	 * @param shelfLifeUOM the shelfLifeUOM to set
	 */
