...
public class InspCharacteristic {
	...
	/*Basic Search And Advanced Search*/
	 ...
	 private int advanceBasicSearchHidden;
		...
		private List<InspCharacteristicMethod> inspCharacteristicMethodGroupDetails;
		...
		public List<InspCharacteristicMethod> getInspCharacteristicMethodGroupDetails() {
			return inspCharacteristicMethodGroupDetails;
		}


		public void setInspCharacteristicMethodGroupDetails(
				List<InspCharacteristicMethod> inspCharacteristicMethodGroupDetails) {
