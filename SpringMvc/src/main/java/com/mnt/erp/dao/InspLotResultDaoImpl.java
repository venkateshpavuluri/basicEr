...
public class InspLotResultDaoImpl extends HibernateDaoSupport implements
	...
	public List<Object[]> searchInspLotResult() {
		try {
			String hql = "select dn.InspLotResultId,dn.InspLotNoId,dn.startDate,dn.endDate,dn.inspected,dn.accepted,dn.nonConf,dn.mean,dn.stdValue,dn.skip,dn.inspLotBean from InspLotResultBean dn";
	...
	public List<Object[]> basicSearchInspLotResult(String label,
		...
		try {
			String hql = "select dn.InspLotResultId,dn.InspLotNoId,dn.startDate,dn.endDate,dn.inspected,dn.accepted,dn.nonConf,dn.mean,dn.stdValue,dn.skip,dn.inspLotBean from InspLotResultBean dn where dn."
					+ label + "" + operator + " ? ";
