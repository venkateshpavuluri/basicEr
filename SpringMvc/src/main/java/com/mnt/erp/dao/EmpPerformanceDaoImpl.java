...
public class EmpPerformanceDaoImpl extends HibernateDaoSupport implements EmpPerformanceDao {
	...
	public Long checkEmpPerformance(String equipment) {
	...
	public String updateEmpPerformance(Object object) {
		...
		try {
			...
			System.out.println("fddf"+pLine.getPerformanceReviewKPIId());
	...
	public List<Object[]> basicSearchEmpPerformance(String label, String operator,
		...
		try {
			...
			String hql = "select r.EmpPerformanceSchId,r.EmpPerformanceSchNo,r.equipmentBean from EmpPerformance r where r."
					+ label + "" + operator + " ? ";
