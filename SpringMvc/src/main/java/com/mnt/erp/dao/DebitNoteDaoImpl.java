...
public class DebitNoteDaoImpl extends HibernateDaoSupport implements
	...
	public List<Object[]> searchDebitNote() {
		try {
			String hql = "select dn.debitNoteId,dn.debitNoteNo,dn.debitNoteDT,dn.custInvoiceId,dn.vendorInvoiceId,dn.custInvoice,dn.vendorInvoice from DebitNoteBean dn";
