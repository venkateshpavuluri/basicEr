...
public class EmployeeDaoImpl extends HibernateDaoSupport implements EmployeeDao {
	...
	public String updateEmployee(Object object) {
		/*try {
			Employee updateEmp = (Employee) object;
			getHibernateTemplate().update(updateEmp);

		} catch (Exception e) {
			e.printStackTrace();
		}*/
		
		EmployeeManager pc = null;
		Iterator<EmployeeManager> iterator1 = null;
		EmployeeManager pLine = null;
		Set<EmployeeManager> list2 = null;
		try {

			Employee pg = (Employee) object;
			int id = pg.getEmployee_Id();
			

			Employee po = (Employee) getHibernateTemplate().get(
					Employee.class, id);
			list2 = po.getEmployeeManager();

			iterator1 = list2.iterator();
			while (iterator1.hasNext()) {
				Object o = (Object) iterator1.next();
				pLine = (EmployeeManager) o;
				pc = new EmployeeManager();
				pc.setEmployeeManager_Id(pLine.getEmployeeManager_Id());
			
				pc.setProjectDetails(new Project());
				pc.setManagerDetails(new Employee());
