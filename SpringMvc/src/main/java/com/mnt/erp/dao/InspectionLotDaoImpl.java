...
public class InspectionLotDaoImpl extends HibernateDaoSupport implements
	...
	public List<Object[]> searchInspectionLot() {
		try {
			String hql = "select dn.inspLotNoId,dn.inspLotNo,dn.refNo,dn.quantity,dn.desc,dn.plant,dn.material,dn.uom,dn.inspType,dn.inspLotOrg,dn.status,dn.batchNo from InspectionLotBean dn";
