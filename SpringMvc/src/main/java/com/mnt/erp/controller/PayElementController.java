...
public class PayElementController {
	...
	public String searchPayelement(
		...
		request.setAttribute("payElementValues", "payElementValues");
...
@RequestMapping(value = "/payElementEditHome", method = RequestMethod.GET)
	...
	public String inspectionDetailEdit1(
...
public String deleteInspectionDetail(
...
public String updateInspectionDetail(
