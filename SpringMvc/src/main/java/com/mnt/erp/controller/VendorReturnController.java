	...
	public String addVendorReturn(
		...
		if (list1 == 0) {
			...
			try {
				...
				vendorReturnAdd.setVendorReturnDate(dateService.dateFormat(dateService.dateParse(vendorReturnAdd.getVendorReturnDate(),"au"),"au"));
		...
		try {
			...
			if (basicSearchId == "") {
				...
				while (iterator.hasNext()) {
					...
					vr.setVendorReturnDate(dateService.dateFormat(dateService.dateParse(vr.getVendorReturnDate(),"se"),"se"));
		...
		try {
			...
			if (iterator.hasNext()) {
				...
				vendorReturnIdEdit1.setVendorReturnNoEditt(vr
						.getVendorReturnNo());
				vendorReturnIdEdit1.setVendorReturnDateEditt(dateService.dateFormat(dateService.dateParse(vr.getVendorReturnDate(),"se"),"se")
						);
	...
	public String updateVendorReturn(
		...
		if (list1 == 0) {
			...
			try {
				...
				vrEdit.setVendorReturnDate(dateService.dateFormat(dateService.dateParse(vrEdit.getVendorReturnDateEditt(),"au"),"au"));
