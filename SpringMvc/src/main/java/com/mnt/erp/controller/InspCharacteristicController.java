...
public class InspCharacteristicController {
	...
	public String addInspCharacteristic(@ModelAttribute("inspCharacteristicCommand") InspCharacteristic inspCharacteristic,
		...
		String res=null;
		List<InspCharacteristicMethod> inspCharacteristicMethod = new ArrayList<InspCharacteristicMethod>();
	...
	public String inspCharacteristicEdit(
		...
		List<InspCharacteristicMethod> inspCharacteristicMethodEditList = new ArrayList<InspCharacteristicMethod>();
		...
		try {
			...
			if (itrr.hasNext()) {
				...
				List<InspCharacteristicMethod> listEdit = ccb.getInspCharacteristicMethodGroupDetails();
	...
	public String inspCharacteristicUpdate(
			...
			HttpServletResponse response) {
		response.setCharacterEncoding("UTF-8");
		List<InspCharacteristicMethod> inspCharacteristicUpList = new ArrayList<InspCharacteristicMethod>();
