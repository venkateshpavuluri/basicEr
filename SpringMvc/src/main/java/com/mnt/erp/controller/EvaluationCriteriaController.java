...
public class EvaluationCriteriaController {
	...
	public String saveEvaluationCriteria(
		...
		System.out.println("the sub criteria:"+EvaluationCriteria.getEvaluationSubCriteria());
		System.out.println("the score:"+EvaluationCriteria.getScore());
		if (EvaluationCriteriaList1 == 0) {
			...
			try {
				...
				for (int i = 0; i < evac.length; i++) {
					...
					System.out.println("the sub criter:"+EvaluationSubCriteriass.getEvaluationSubCriteria());
					EvaluationSubCriteriass.setScore(scores[i].toString());
					System.out.println("the score:"+EvaluationSubCriteriass.getScore());
	...
	public String editEvaluationCriteria(
		...
		try {
			...
			while (iterator.hasNext()) {
				...
				System.out.println("the list is:"+listEdit.size());
				...
				while (iterate.hasNext()) {
					...
					System.out.println("the eval:"+resReEdit.getEvaluationSubCriteriaEdit());
	...
	public String updateEvaluationCriteria(
		...
		String evaluationCriteria = EvaluationCriteria.getEvaluationCriteriaEdit();
		int id = EvaluationCriteria.getEvaluationCriteriaIdEdit();
		EvaluationCriteria.setEvaluationCriteriaId(EvaluationCriteria.getEvaluationCriteriaIdEdit());
		EvaluationCriteria.setEvaluationCriteria(EvaluationCriteria.getEvaluationCriteriaEdit());
		EvaluationCriteria.setWeightingFactor(EvaluationCriteria.getWeightingFactorEdit());
		...
		if (EvaluationCriteriaEditList == 0) {
			...
			try {
				String rating = EvaluationCriteria.getEvaluationSubCriteriaEdit();
				...
				String kpis = EvaluationCriteria.getScoreEdit();
				
				List<String> kpiList = Arrays.asList(kpis.split(","));
				Object[] kpiIds = kpiList.toArray();
				
			
				int[] empPerUpdate = EvaluationCriteria.getEveCriteriaEditt();
				...
				EvaluationCriteria.setEvaluationSubCriterias(evaluationCriteriaList);
				System.out.println("the eval cri:"+EvaluationCriteria.getEvaluationCriteria());
				System.out.println("the we:"+EvaluationCriteria.getWeightingFactor());
				
				String msg = evaluationCriteriaService.updateEvaluationCriteria(EvaluationCriteria);
