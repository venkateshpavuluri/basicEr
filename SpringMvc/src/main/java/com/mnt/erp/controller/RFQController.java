...
public class RFQController {
	...
	public String saveRfq(@ModelAttribute("RFQ") RfqBean rfqbean,
		...
		try {
			rfqbean.setRfqDate(dateService.dateFormat(
					dateService.dateParse(rfqbean.getRfqDate(), "au"), "au"));
	...
	public String rfqAdvanceSearchOperations(@ModelAttribute RfqBean rfqbean,
			HttpServletRequest request, HttpServletResponse response) {
